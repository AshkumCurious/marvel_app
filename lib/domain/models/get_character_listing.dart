class GetCharacterListing {
  ...
  factory GetCharacterListing.fromJson(Map<String, dynamic> json) {
    return GetCharacterListing(
      code: json.containsKey("code") ? json["code"] : 0,
      status: json.containsKey("status") ? json["status"] : "",
      copyright: json.containsKey("copyright")? json["copyright"] : "",
      attributionText: json.containsKey("attributionText")?json["attributionText"] : "",
      attributionHtml: json.containsKey("attributionHTML")?json["attributionHTML"] : "",
